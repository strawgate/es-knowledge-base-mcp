    ...
    [
        ...
        (
            "http://example.com/full-path/to/resource/",
            {
                ...
                "page_url": "http://example.com/full-path/to/resource/",
                "filter_pattern": "/full-path/to/resource/",  # Uses the full seed_dir
        ...
        (
            ...
            {
                "domain": "http://example.com",
                "page_url": "http://example.com/docs/main/subsection/",
                "filter_pattern": "/docs/main/subsection/",
        ...
        (
            "http://localhost:8080/my/app/",
            {
                ...
                "page_url": "http://localhost:8080/my/app/",
        ...
        (
            "https://developer.mozilla.org/en-US/docs/Web/API/",
            {
                ...
                "page_url": "https://developer.mozilla.org/en-US/docs/Web/API/",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            {
                "domain": "http://example.com",
                "page_url": "http://example.com/full-path/to/resource/index.html",
        ...
        (
            "https://www.elastic.co/guide/en/index.html",
            {
                ...
                "page_url": "https://www.elastic.co/guide/en/index.html",
        ...
        (
            "https://www.rfc-editor.org/rfc/rfc9110.html",
            {
                ...
                "page_url": "https://www.rfc-editor.org/rfc/rfc9110.html",
                "filter_pattern": "/rfc/",
        ...
        (
            ...
            {
                "domain": "http://example.com",
                "page_url": "http://example.com/section",
                "filter_pattern": "/",  # Path is just '/'
