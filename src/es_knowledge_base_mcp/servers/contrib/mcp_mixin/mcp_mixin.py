    ...
    def register_resources(
        ...
        Args:
            ...
            separator: The separator string used between prefix and original name/URI.
                Defaults to '+'.
        """
        for method, registration_info in self._get_methods_to_register(_MCP_REGISTRATION_RESOURCE_ATTR):
            if prefix:
                registration_info["name"] = f"{prefix}{separator}{registration_info['name']}"
                registration_info["uri"] = f"{prefix}{separator}{registration_info['uri']}"
    ...
    def register_prompts(
        ...
        Args:
            ...
            separator: The separator string used between prefix and original name.
                Defaults to '_'.
        """
        for method, registration_info in self._get_methods_to_register(_MCP_REGISTRATION_PROMPT_ATTR):
            if prefix:
                registration_info["name"] = f"{prefix}{separator}{registration_info['name']}"
